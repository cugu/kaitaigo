...
successful_tests:
	...
	@go test gitlab.com/cugu/kaitai.go/parser/kaitai/repeat_eos_u4 # fix tests, typecast
...
failing_tests:
	...
	@# go test -v gitlab.com/cugu/kaitai.go/parser/kaitai/instance_std_array  & true # TODO
